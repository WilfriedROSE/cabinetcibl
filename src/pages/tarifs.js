        ...
        <MainLayout title="Nos Tarifs" description="Bienvenue sur la page Nos Tarifs de notre site">
            <div className="bg-customBeige">
                ...
                <div className="flex flex-col items-center justify-center text-center bg-gray-100">
                    <p className="text-extrabold mt-20 text-5xl sm:text-6xl md:text-7xl font-catchy text-customBrown text-center tracking-wide">Nos Modalités d’intervention</p>
                    <div>
                        <p className="mx-4 sm:mx-10 md:mx-24 lg:mx-48 my-10 text-base sm:text-lg md:text-xl text-justify leading-relaxed font-cocoGothic text-customBrown tracking-wide">
                        ...
                        <p className="mx-4 sm:mx-10 md:mx-24 lg:mx-48 mt-10 mb-3 text-base sm:text-lg md:text-xl font-medium leading-relaxed font-cocoGothic text-customBrown tracking-wide">
                            Nous proposons à nos patients :
                        </p>
                        <ul className="list-disc ml-8 sm:ml-12 md:ml-24 lg:ml-60 mx-4 sm:mx-10 md:mx-24 lg:mx-48 mb-10 text-base sm:text-lg md:text-xl text-justify leading-relaxed font-CocoGothic text-customBrown tracking-wide">
                ...
                <div className="flex flex-col items-center justify-center text-center bg-customBeige">
                    <h2 className="text-extrabold mt-10 text-6xl sm:text-7xl md:text-8xl font-catchy text-customBrown text-center tracking-wide">Tarifs</h2>
                </div>
                <div className="mt-10 mb-10 max-w-6xl mx-auto px-6 py-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center justify-center text-center bg-gray-100">
                    <p className="text-extrabold mt-20 text-6xl sm:text-7xl md:text-8xl font-catchy text-customBrown text-center tracking-wide">Informations pratiques</p>
                    <div className="mx-4 sm:mx-10 md:mx-24 lg:mx-48 my-10 text-base sm:text-lg md:text-xl text-justify leading-relaxed font-cocoGothic text-customBrown tracking-wide">
                        <h3 className="text-2xl sm:text-3xl font-coco text-customBrown">Modalités de paiement</h3>
                        ...
                        <h3 className="text-2xl sm:text-3xl font-coco text-customBrown mt-20">Remboursement des consultations</h3>
                        <p className="text-customBrown mt-2">
                        ...
                        <h3 className="text-2xl sm:text-3xl font-coco text-customBrown mt-20">Retards et annulations</h3>
