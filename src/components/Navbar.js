                    ...
                    <ul className="font-bold flex flex-col p-4 md:flex-row md:space-x-8 md:p-0 md:mt-0">
                        ...
                        <li className="relative group">
                            <button
                                ...
                                className="flex items-center py-2 px-3 text-customBrown w-full md:w-auto">
                                Nos Thérapies
                                <svg className={`w-4 h-4 ml-2 transition-transform ${isDropdownOpen ? "rotate-180" : "rotate-0"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul className={`${isDropdownOpen ? "block" : "hidden"} md:absolute left-0 mt-2 bg-customBeige shadow-lg rounded-md w-48 md:group-hover:block`}>
                                <li>
                                    <Link href="/Thérapie de Couples" className="block py-2 px-4 text-customBrown hover:bg-gray-200">
                                        Thérapie de Couples
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/Thérapie de Familles" className="block py-2 px-4 text-customBrown hover:bg-gray-200">
                                        Thérapie de Familles
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/Accompagnement d'équipes" className="block py-2 px-4 text-customBrown hover:bg-gray-200">
